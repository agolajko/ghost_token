...
async def test_import_branch(starknet_ins: Starknet, branch_contract: StarknetContract):
    ...
    root_hash, merkle_branch_high, merkle_branch_low = generate_proof(block_num=, contract_address=, var_name=)
    ...
    res_hash = await branch_contract.verify_both_branches(real_leaf, real_branch_rest, total_len, root_hash).call()
    return()
"""
